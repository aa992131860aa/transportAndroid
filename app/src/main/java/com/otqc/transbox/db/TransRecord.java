 ...
 * 转运开始时间：生成转运单的时间。
 */
public class TransRecord extends DataSupport {
    ...
    public String toString() {
        ...
        return "{\"id\":\""+id+"\",\"transfer_id\":\"" + transfer_id + "\",\"temperature\":\"" + temperature + "\",\"power\":\"" + power + "\",\"humidity\":\"" + humidity + "\",\"collision\":\""
                + collision + "\",\"open\":\"" + open + "\",\"duration\":\"" + duration + "\",\"currentCity\":\"" + currentCity + "\",\"expendPower\":\"" + expendPower +
                "\",\"recordAt\":\"" + recordAt + "\",\"distance\":\"" + distance + "\",\"longitude\":\"" + longitude + "\",\"latitude\":\"" + latitude + "\",\"transferId\":\""
                + CONSTS.TRANSFER_ID + "\",\"remark\":\"" + remark + "\",\"voltage\":\""+voltage+"\",\"trueTemperature\":\"" + trueTemperature + "\",\"other\":\"" + other + "\"}";
    }
