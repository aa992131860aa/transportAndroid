 ...
 * 转运开始时间：生成转运单的时间。
 */
public class TransRecordItemDbNew1 extends RealmObject implements Serializable,TransferRecord{
    ...
    private double collision; //碰撞
    private double open; //开箱
    ...
    public String toString() {
        return "{\"transfer_id\":\""+transfer_id+"\",\"temperature\":\""+temperature+"\",\"power\":\""+power+"\",\"humidity\":\""+humidity+"\",\"collision\":\""
                ...
                "\",\"recordAt\":\""+recordAt+"\",\"distance\":\""+distance+"\",\"longitude\":\""+longitude+"\",\"latitude\":\""+latitude+"\",\"transferId\":\""+ CONSTS.TRANSFER_ID+"\"}";
    }
