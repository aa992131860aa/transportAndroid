...
import org.redsha.transbox.engine.SerialDataUtils;
...
import org.redsha.transbox.util.CRC16M;
...
//                            ToastUtil.showToast("门锁已关闭!");
    ...
    public void onMessageEvent(OpenBoxEvent event) {
        if (event.isState()) {
            // 开 指令
            isOrderState = 1;   // 开
            send("30 10 00 05 00 01 02 00 01 3E 54");
        } else {
            // 关 指令
            isOrderState = 2;   // 关
            send("30 10 00 05 00 01 02 00 00 FF 94");
        }
